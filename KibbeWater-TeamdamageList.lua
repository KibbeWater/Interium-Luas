...
Menu.Text("Color Scheme")
Menu.Combo( "", "cTDamageDesign", { "Default", "Light", "RGB" }, 0)
Menu.Separator()
...
Hack.RegisterCallback("PaintTraverse", function ()
    ...
    if Menu.GetInt("cTDamageDesign") == 0 then 
        clr = Color.new(255,255,255,255) 
        clrBG = Color.new(0,0,0,255)
    elseif Menu.GetInt("cTDamageDesign") == 1 then 
        clr = Color.new(0,0,0,255) 
        clrBG = Color.new(255,255,255,255)
    end

    Render.RectFilled(posX, posY, posX + xSize, posY + sizeY, clrBG, 0)
    if Menu.GetInt("cTDamageDesign") == 2 then Render.RectFilledMultiColor(posX + 4, posY + 7, (posX + xSize) - 4, posY + sizeY - 7, Color.new(R[4], G[4], B[4], 255),Color.new(R[1], G[1], B[1], 255),Color.new(R[1], G[1], B[1], 255),Color.new(R[4], G[4], B[4], 255)) else Render.RectFilled(posX + 4, posY + 7, (posX + xSize) - 4, posY + sizeY - 7, clr, 0) end
